...
import com.bayu.stacknotif.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun sendNotif() {
        ...
        val largeIcon = BitmapFactory.decodeResource(resources, R.drawable.baseline_notifications_24)
        ...
        if (idNotification < MAX_NOTIFICATION) {
            mBuilder = NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .setSmallIcon(R.drawable.baseline_mail_20)
